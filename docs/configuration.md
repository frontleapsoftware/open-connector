...
| `OOMOL_CONNECT_REDIS_URL`                   | unset                            | Optional Redis URL. Enables an in-memory L1 cache with pub/sub invalidation across Node replicas. See [ha-postgres.md](ha-postgres.md).                                     |
| `OOMOL_CONNECT_CACHE_TTL_MS`                | `30000`                          | Soft TTL for the Redis-backed L1 cache.                                                                                                                                     |
